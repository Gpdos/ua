<header>
        ...
        <div id="cen">
            ...
            <a href="error.php" style="text-decoration: none; color: white; text-align: center; display: block;">
            ...
            <a href="error.php" style="text-decoration: none; color: white; text-align: center; display: block;">
                ...
                <span style="display: block; font-size: 12px;">Crear</span>
            </a>


            <a href="login.php" style="text-decoration: none; color: white; text-align: center; display: block;">
                <i class="fa-solid fa-sign-in-alt"></i>
                <span style="display: block; font-size: 12px;">Iniciar Sesión</span>
            </a>
